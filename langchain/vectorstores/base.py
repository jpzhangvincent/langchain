...
class VectorStore(ABC):
    ...
    async def asimilarity_search_with_relevance_scores(
        ...
        """Return docs most similar to query but with thresholds."""

        # This is a temporary workaround to make the similarity search with relevance 
        # scores asynchronous. The proper solution is to make the similarity search
        # asynchronous in the vector store implementations.
